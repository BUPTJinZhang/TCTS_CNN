...
import os.path
import numpy as np
from nets import TrajectoryletNet as  TrajNet
...
tf.app.flags.DEFINE_integer('joints_number', 22,
...
def main(argv=None):
    ...
    for itr in range(1, FLAGS.max_iterations + 1):
        ...
        if itr % FLAGS.test_interval == 0:
            ...
            print('test...')
            str1 = 'walking eating smoking discussion directions greeting phoning posing purchases sitting sittingdown takingphoto waiting walkingdog walkingtogether'
            str1 = str1.split(' ')
