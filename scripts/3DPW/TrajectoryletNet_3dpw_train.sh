...
savepath='./exp/3dpw/results'
modelpath='./exp/3dpw/models'
bak_path='./exp/3dpw/bak6'
#sleep 4h
mkdir ${modelpath}
mkdir ${savepath}
mkdir ${bak_path}
logname='logs/3DPW/1_20.log'
nohup python -u train_TrajectoryletNet_3dpw.py \
    --is_training True \
    --dataset_name skeleton \
    --train_data_paths train_3dpw0_25.npy \
    --valid_data_paths test_3dpw0_25.npy \
    --save_dir ${modelpath} \
    --gen_dir ${savepath} \
    --bak_dir ${bak_path}   \
